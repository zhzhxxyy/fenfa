...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'Ear Music Board 管理中心 - 系统 - 充值记录';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;充值记录';</script>
<div class="floattop"><div class="itemtitle"><h3>充值记录</h3></div></div><div class="floattopempty"></div>
<table class="tb tb2">
...
if($count==0){
?>
<tr><td colspan="2" class="td27">没有充值记录</td></tr>
<?php
}
if($result){
